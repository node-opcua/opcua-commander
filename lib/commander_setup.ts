...
program
  ...
  .option("-e, --endpoint <endpoint>", "the endpoint to connect to")
  ...
  .option("-y, --securityPolicy <policy>", "the security policy (Basic128Rsa15, Basic256, Basic256Sha256, Aes128_Sha256_RsaOaep, Aes256_Sha256_RsaPss)")
  .option("-P <policy>", "the security policy (alias for -y)")
